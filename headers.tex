...
\newcommand{\cw}{\copyright Big Company}
\newcommand{\license}{\cc Creative Commons BY-NC-SA}
      ...
      \begin{column}{0.4\textwidth}
        \begin{block}{\huge{Response Headers:}}
          ...
          \begin{tabular}{r p{0.45\textwidth} p{0.35\textwidth}}
            ...
            Last-Modified & The date at which the resource was last modified & \header{Last-Modified: Sat, 13 Oct 2012 09:35:00 GMT } \\
            ...
            Set-Cookie & Set an HTTP cookie & \header{UserID=jesusabdullah; Max-Age=3600; Version=1 } \\
